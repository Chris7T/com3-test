...
class DepartmentGetTest extends TestCase
{
    private const ROUTE = 'department.get';
    ...
    {
        $response = $this->getJson(route(self::ROUTE, $this->department->getKey()));
    ...
    {
        $response = $this->actingAs($this->user)->getJson(route(self::ROUTE, $this->department->getKey()));

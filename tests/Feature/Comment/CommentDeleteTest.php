...
{
    private const ROUTE = 'comment.delete';
    ...
    {
        $response = $this->deleteJson(route(self::ROUTE, $this->comment->getKey()));
    ...
    {
        $response = $this->actingAs($this->user)->deleteJson(route(self::ROUTE, $this->comment->getKey()));
